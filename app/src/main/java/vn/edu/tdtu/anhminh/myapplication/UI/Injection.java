...
public class Injection {
    ...
    public static SyncSampleRecipesUseCase provideSyncSampleRecipesUseCase() {
        return new SyncSampleRecipesUseCase(new RecipeSyncService(appContext));
    }
    ...
    public static ViewModelFactory provideViewModelFactory() {
        return new ViewModelFactory(
                ...
                provideSyncSampleRecipesUseCase()
        );
    }
}