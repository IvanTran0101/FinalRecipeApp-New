...
public class IngredientMapper {
    ...
    public static IngredientEntity toEntity(IngredientDTO dto){
        ...
        // The ID is not set from the DTO; it will be auto-generated by Room.
        // The Recipe ID is also not set here; it's set in the Repository after the parent recipe is inserted.
    ...
    public static List<IngredientEntity> toEntityListFromDto(List<IngredientDTO> dtos) {
    ...
    public static IngredientEntity toEntity(Ingredient model) {
        ...
        // Use default constructor and setters
        IngredientEntity entity = new IngredientEntity();
        // The ID is crucial for updates. If null, Room will treat it as an insert.
        entity.setIngredientId(model.getIngredientId());
    ...
    public static List<IngredientEntity> toEntityListFromModel(List<Ingredient> models) {
        if (models == null) return null;

        List<IngredientEntity> list = new ArrayList<>();
        for (Ingredient model : models) {
            IngredientEntity entity = toEntity(model);
            if (entity != null) {
                list.add(entity);
            }
        }
